...
import si.fri.rsoteam.models.converters.Event;
...
public class EventsBean {
    ...
    @GET
    @Path("/{id}")
    private Response getEvent(@PathParam("id") Integer id){
     ...
     * @param event Event with new properties.
     * @return Response object containing updated event object.
     * */
//
//    @POST
//    private Response updateEvent(Event event, Integer id){
//        this.beginTx();
//        Event oldEvent = em.find(Event.class, id);
...
//    }
     ...
     * @param event  Event to remove from database.
